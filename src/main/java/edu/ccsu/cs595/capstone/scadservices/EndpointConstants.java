...
public class EndpointConstants {
	...
	public static final String SCADLEAGUEID = "scadLeagueId";
	public static final String SCADTEAMID = "scadTeamId";
	...
	public static final String SCADLEAGUE_RESOURCE_ID = "The SCAD League ID of the resource.";
	public static final String SCADLEAGUETEAM_RESOURCE_ID = "The SCAD Team ID of the resource.";
